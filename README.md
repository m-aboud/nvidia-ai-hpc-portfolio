...
| [[`ai-cluster-capacity-planner`](https://github.com/m-aboud/ai-cluster-capacity-planner)] | AI/HPC GPU cluster sizing tool | Python, power/cooling/PUE modeling, tested CLI |
| [[`gpu-observability-platform`](https://github.com/m-aboud/gpu-observability-platform)] | NVIDIA GPU monitoring stack | DCGM Exporter, Prometheus, Grafana, Docker, observability |
